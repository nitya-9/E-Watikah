...
$confirm =  hash('sha256', $salt . $confirm_new);
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="change_password.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
    </p>
  </div>
</div>
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" method="post">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-confirm-password">New Password <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
