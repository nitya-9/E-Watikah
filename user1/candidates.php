        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Senarai Cadangan Pegawai</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Senarai Cadangan Pegawai</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <a href="add_candidates.php"><button type="button" class="btn btn-primary">Tambah Cadangan Pegawai</button></a>
...
try {
    ...
    echo "Error: " . $e->getMessage();
                    ...
                    <td style="width:50px"><?php echo $value['othersnewpost'];?></td>
                       ...
                       <td style="width: 20px"><a href="candidates.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Padam"></i></a>
