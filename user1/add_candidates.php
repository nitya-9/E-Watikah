...
try {
    ...
    $stmt1 = $conn->prepare("SELECT * FROM candidate1");
   $stmt1->execute();
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Cadangan Pegawai</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Cadangan Pengawai</a></li>
                  ...
                  <div class="card card-outline-primary">
                             ...
                             <form action="operations/candidate.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                              <div class="form-group has-danger">
                                                  <label class="control-label">Gred Penyandang</label>
                                                   <input type="text" class="form-control" id="gred" name="gred" placeholder="Masuk Gred Penyandang" required>
                                          </div>
                                      </div>
                                        ...
                                        <div class="col-md-6">
                                              <div class="form-group has-danger">
                                                  <label class="control-label">Alamat Rumah</label>
                                                   <input type="text" class="form-control" id="address" name="address" placeholder="Masuk Alamat Rumah" required>
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                           <div class="form-group has-danger">
                                ...
                                <div class="col-md-6">
                                     <div class="form-group has-danger">
                                       ...
                                       <input type="text"  class="form-control" id="newplace" name="newplace" placeholder="Masuk Penempatan Baru" required>
                                 </div>
                             </div>
                                <div class="col-md-6">
                                     <div class="form-group has-danger">
                                         <label class="control-label">Jarak Kediaman Dari Pejabat Asal (KM)</label>
                                       <input type="text"  class="form-control" id="distancecurrent" name="distancecurrent" placeholder="Masuk Jarak" required>
                                 </div>
                             </div>
                             <div class="col-md-6">
                                  <div class="form-group has-danger">
                                      <label class="control-label">Jarak Kediaman Dari Pejabat Baru (KM)</label>
                                    <input type="text"  class="form-control" id="distancenew" name="distancenew" placeholder="Masuk Jarak" required>
                              </div>
                          </div>
                       ...
                       <div class="col-md-6">
                            <div class="form-group has-danger">
                                ...
                                <option value=""> Pilih Jawatan</option>
                                <option value="Guru Besar">Guru Besar</option>
                                <option value="Guru Besar (Lantikan Baharu)">Guru Besar (Lantikan Baharu)</option>
                                <option value="Pengetua">Pengetua</option>
                                <option value="Guru Penolong Kanan Pentadbiran">Guru Penolong Kanan Pentadbiran</option>
                                <option value="Guru Penolong Kanan Hal Ehwal Murid">Guru Penolong Kanan Hal Ehwal Murid</option>
                                <option value="Guru Penolong Kanan Kokurikulum">Guru Penolong Kanan Kokurikulum</option>
                  ...
                  <input type="date"  class="form-control" id="enddate3" name="enddate3" placeholder="" >
                    ...
                    <div class="col-md-6">
                         <div class="form-group has-danger">
                           ...
                           <input type="text"  class="form-control" id="justification" name="justification" placeholder="Masuk Justifikasi" required>
                     </div>
                 </div>
                 <div class="col-md-6">
                      <div class="form-group has-danger">
                               ...
                               <img src="../admin/upload/<?php echo $image;?>" width="20" height="20">
                                <input type="hidden" name="old_img" value="<?php echo $image;?>">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="add_booking.php"><button type="button" class="btn btn-inverse">Batal</button></a>
                                    </div>
                                </form>
                            </div>
                    </div>
