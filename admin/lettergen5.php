...
$query = mysqli_query($con,"select * from candidate
	where
	id = '".$_GET['id']."' and positionof = 'Guru Besar'");
...
$pdf->Cell(110	,3,'',0,1);
$pdf->Cell(29	,3,'',0,0);
$pdf->MultiCell(149,5,"$name, Pegawai Perkhidmatan Pendidikan (PPP) Gred $gred, $position$others, $workplace, Negeri Sembilan, ditempatkan sebagai $positionof$othersnewpost, $newplace, Negeri Sembilan. Pegawai Perkhidmatan Pendidikan (PPP), Gred $gred. Gred hakiki jawatan adalah Gred $actgred. ",0,'J');
...
$pdf->Cell(110	,3,'',0,1);
$pdf->Cell(15	,3,'',0,0);
$pdf->MultiCell(164,5,'4.     Ketua  Jabatan  dikehendaki  menyediakan Penyata Perubahan (KEW. 8), mengemukakan Sijil Gaji Akhir, Buku Perkhidmatan Kerajaan dan Laporan Nilaian Prestasi Tahunan (LNPT) / Penilaian Bersepadu Pegawai Perkhidmatan Pendidikan (PBPPP) kepada Ketua Jabatan yang baru serta mengarahkan pegawai berkenaan menyediakan Nota Serah Tugas (jika berkaitan). Perubahan-perubahan ini hendaklah di catatkan dalam Buku Perkhidmatan Kerajaan pegawai dan dikemaskini dalam sistem HRMIS dalam tempoh tiga puluh (30) hari, mengikut Pekeliling Perkhidmatan Bilangan 12 Tahun 2005.  ',0,'J');
