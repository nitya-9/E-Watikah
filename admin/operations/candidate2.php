    ...
    if(isset($_POST['submit']))
    {
      ...
      $file_store="../../admin/upload/".$file_name;
       if (move_uploaded_file($file_tem_loc, $file_store)){
        ...
        $sql = "INSERT INTO candidate2 (flow, unit, name, icno, others, actgred, gred, workplace,postcode, retiredate, address, currentdate1, currentdate2, modeofchange,newplace, distancecurrent, distancenew,total, positionhist,positionhist2,positionhist3,placehist,placehist2,placehist3,startdate1,startdate2,startdate3,enddate1,enddate2,enddate3, justification, notes, takefrom, othersnewpost, image)
            VALUES ('".$_POST['flow']."','".$_POST['unit']."','".$_POST['name']."', '".$_POST['icno']."', '".$_POST['others']."','".$_POST['actgred']."','".$_POST['gred']."','".$_POST['workplace']."','".$_POST['postcode']."','".$_POST['retiredate']."','".$_POST['address']."','".$_POST['currentdate1']."','".$_POST['currentdate2']."',
            '".$_POST['modeofchange']."','".$_POST['newplace']."','".$_POST['distancecurrent']."','".$_POST['distancenew']."','".$_POST['total']."','".$_POST['positionhist']."','".$_POST['positionhist2']."','".$_POST['positionhist3']."','".$_POST['placehist']."','".$_POST['placehist2']."','".$_POST['placehist3']."','".$_POST['startdate1']."','".$_POST['startdate2']."','".$_POST['startdate3']."','".$_POST['enddate1']."','".$_POST['enddate2']."','".$_POST['enddate3']."','".$_POST['justification']."','".$_POST['notes']."','".$_POST['takefrom']."','".$_POST['othersnewpost']."', '".$file_name."' )";
...
flow='".$_POST['flow']."',
  unit='".$_POST['unit']."',
    ...
    if(isset($_GET['id']))
    {
        $sql = "DELETE FROM candidate2 WHERE id='".$_GET['id']."'";
