    ...
    if(isset($_POST['submit']))
    {
      ...
      $file_store="../../admin/upload/".$file_name;
       if (move_uploaded_file($file_tem_loc, $file_store)){
        ...
        $sql = "INSERT INTO candidate4 (no, flow, unit, name, icno, position, others, actgred, gred, workplace, postcode, retiredate, address, currentdate1, currentdate2, modeofchange,newplace, distancecurrent, distancenew, total,positionhist,positionhist2,positionhist3,placehist,placehist2,placehist3,startdate1,startdate2,startdate3,enddate1,enddate2,enddate3, justification, notes, takefrom, positionof,othersnewpost, image )
            VALUES ('".$_POST['no']."','".$_POST['flow']."','".$_POST['unit']."','".$_POST['name']."', '".$_POST['icno']."', '".$_POST['position']."','".$_POST['others']."','".$_POST['actgred']."','".$_POST['gred']."','".$_POST['workplace']."','".$_POST['postcode']."','".$_POST['retiredate']."','".$_POST['address']."','".$_POST['currentdate1']."','".$_POST['currentdate2']."',
      ...
      if(is_dir($folder))
       {
        ...
        $sql = "UPDATE candidate4 SET no='".$_POST['no']."',
flow='".$_POST['flow']."',
  unit='".$_POST['unit']."',
        name='".$_POST['name']."',
    icno='".$_POST['icno']."',
    ...
    if(isset($_GET['id']))
    {
        $sql = "DELETE FROM candidate4 WHERE id='".$_GET['id']."'";
