                              ...
                              <form method='get' action='print2.php'>
                                <select name='flow'>
                                  <?php
                                    ...
                                    $query = mysqli_query($con,"select flow from candidate2 group by flow");
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM candidate2");
    $stmt->execute();
    ...
    if(isset($_GET['id']))
      {
        $id=$_GET['id'];
          $stmt1 = $conn->prepare("SELECT * FROM candidate2 order by flow,id where id='".$_GET['id']."'");
       $stmt1->execute();
    ...
    echo "Error: " . $e->getMessage();
                       ...
                       <td style='max-width:60%; text-align: left;'>
                         ...
                         <form action="operations/statuscan2.php?edit_id=<?php echo $value ['id'];?>" method="post" enctype="multipart/form-data">
...
<br>
       ...
       <a href="status2.php"><button type="button" class="btn btn-inverse">Batal</button></a>
   </div>
</form>
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
    <?php echo "<script>
  setTimeout(\"location.href='status2.php'\", 2000);
