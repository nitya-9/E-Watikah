...
//get invoices data
$query = mysqli_query($con,"select * from candidate3
	where
	id = '".$_GET['id']."'");
...
$pdf->Cell(110	,3,'',0,1);
$pdf->Cell(15	,3,'',0,0);
$pdf->Cell(130,5,'Ketua Penolong Pengarah',0,1);
$pdf->SetFont('Arial','',11);
$pdf->Cell(15	,3,'',0,0);
...
//items
$query = mysqli_query($con,"select * from candidate3 where id = '".$candidate['id']."' ");
$tax = 0; //total tax
