...
<a href="status3.php" class="button button--error" data-for="js_success-popup">Tidak</a>
</p>
</div>
</div>
<?php } ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Senarai Cadangan Pegawai JPNNS</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Senarai Cadangan Pegawai JPNNS</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              <form method='get' action='print3.php'>
                                <select name='flow'>
                                  <?php
                                    //show invoices list as options
                                    $query = mysqli_query($con,"select flow from candidate3 group by flow");
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM candidate3");
    $stmt->execute();
    ...
    if(isset($_GET['id']))
      {
        $id=$_GET['id'];
          $stmt1 = $conn->prepare("SELECT * FROM candidate3 order by flow,id where id='".$_GET['id']."'");
       $stmt1->execute();
    ...
    echo "Error: " . $e->getMessage();
                            ...
                            <tr>
                                ...
                                <td style="width:10px"><?php echo $value['flow'];?></td>
                                    ...
                                    Jawatan Semasa: <?php echo $value['others'];?><br>
                       ...
                       <td style='max-width:60%; text-align: left;'>
                         ...
                         <form action="operations/statuscan3.php?edit_id=<?php echo $value ['id'];?>" method="post" enctype="multipart/form-data">
...
<br>
       ...
       <a href="status3.php"><button type="button" class="btn btn-inverse">Batal</button></a>
   </div>
</form>
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
    <?php echo "<script>
  setTimeout(\"location.href='status3.php'\", 2000);
