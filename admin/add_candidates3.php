...
try {
    ...
    $stmt1 = $conn->prepare("SELECT * FROM candidate3");
   $stmt1->execute();
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Cadangan Pegawai JPNNS</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Cadangan Pengawai JPNNS</a></li>
            ...
            <div class="container-fluid">
                  ...
                  <div class="card card-outline-primary">
                       <div class="card-body">
                             <form action="operations/candidate3.php" method="post"  enctype="multipart/form-data">
                                    <div class="form-body">
                                      ...
                                      <option value="">Lain-lain</option>
                                            ...
                                            <div class="col-md-6">
                                                  <div class="form-group has-danger">
                                                      <label class="control-label">Jawatan Semasa</label>
                                                       <input type="text" class="form-control" id="others" name="others" placeholder="Masuk Jawatan" required>
                                              </div>
                                          </div>
                                ...
                                <div class="col-md-6">
                                     <div class="form-group has-danger">
                                       ...
                                       <input type="text"  class="form-control" onkeyup="calculate()" id="distancecurrent" name="distancecurrent" placeholder="Masuk Jarak" >
                                 </div>
                             </div>
                             <div class="col-md-6">
                                  <div class="form-group has-danger">
                                      <label class="control-label">Jarak Kediaman Dari Pejabat Baru (KM)</label>
                                    <input type="text"  class="form-control" onkeyup="calculate()" id="distancenew" name="distancenew" placeholder="Masuk Jarak" >
                              </div>
                          </div>
             ...
             <input type="hidden" name="old_img" value="<?php echo $image;?>">
                  ...
                  <option value="Tunggu">Tunggu</option>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="add_candidates3.php"><button type="button" class="btn btn-inverse">Batal</button></a>
                                    </div>
                                </form>
                            </div>
                    </div>
