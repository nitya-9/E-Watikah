                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <a href="add_candidates3.php"><button type="button" class="btn btn-primary">Tambah Cadangan Pegawai</button></a>
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM candidate3 order by flow,id");
    $stmt->execute();
    ...
    echo "Error: " . $e->getMessage();
                       ...
                       <td style="width: 20px"><a href="candidates3.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Padam"></i></a>

                       <a href="update_candidates3.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" title="Kemas Kini"></i></a>
