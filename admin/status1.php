        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Senarai Cadangan Pegawai Unit Menengah</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Senarai Cadangan Pegawai Unit Menengah</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              <form method='get' action='print1.php'>
                                <select name='flow'>
                                  <?php
                                    //show invoices list as options
                                    $query = mysqli_query($con,"select flow from candidate1 group by flow");
                              ...
                              <!--a href="print1.php"><button type="button" class="btn btn-primary">Cetak</button></a-->
                                    ...
                                    <table style="text-align: left;" id="example235" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <td style='max-width:60%;'><b>Pilih Status</b></td>
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM candidate1 order by flow, no");
    $stmt->execute();
    ...
    if(isset($_GET['id']))
      {
        $id=$_GET['id'];
          $stmt1 = $conn->prepare("SELECT * FROM candidate1 order by flow, no where id='".$_GET['id']."'");
       $stmt1->execute();
    ...
    echo "Error: " . $e->getMessage();
                       ...
                       <td style='max-width:60%; text-align: left;'>



                         <form action="operations/statuscan1.php?edit_id=<?php echo $value ['id'];?>" method="post" enctype="multipart/form-data">
...
<br>
       ...
       <a href="status1.php"><button type="button" class="btn btn-inverse">Batal</button></a>
   </div>
</form>
                   ...
                   <td style="width:20px; color: blue; text-align: center; font-size: 20px"><br><br><br><b><?php echo $value['status'];?><b></td>
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
    <?php echo "<script>
  setTimeout(\"location.href='status1.php'\", 2000);
