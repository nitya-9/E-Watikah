...
<?php include"sidebar.php"?>
 ...
 try {
  ...
  if(isset($_GET['id']))
    {
      $id=$_GET['id'];
        $stmt1 = $conn->prepare("SELECT * FROM candidate2 where id='".$_GET['id']."'");
     $stmt1->execute();
  ...
  header("location:../candidates2.php");
    }
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Kemas Kini Maklumat Pegawai PPD</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Kemas Kini Maklumat Pegawai PPD</a></li>
            ...
            <div class="container-fluid">
                  ...
                  <div class="card card-outline-primary">
                       <div class="card-body">
                            <form action="operations/candidate2.php?edit_id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
                              <div class="form-body">
                                    ...
                                    <!--div class="col-md-6">
                                          <div class="form-group has-danger">
                                              <label class="control-label">ID</label>
                                               <input type="text" class="form-control" id="id" value="<?php echo $id;?>" name="id" placeholder="Masuk ID" required>
                                      </div>
                                  </div-->
                                  <div class="col-md-6">
                                        <div class="form-group has-danger">
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                <label class="control-label">Jawatan Semasa</label>
                                                 <input type="text" class="form-control" id="others" value="<?php echo $others;?>" name="others" placeholder="Masuk Jawatan" required>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6" >
                         <div class="form-group has-danger">
                           ...
                           <input type="text"  class="form-control" id="total" name="total" value="<?php echo $total;?>" placeholder="Masuk Jarak" readonly>
                     </div>
                    </div>
                 ...
                 <!--div class="col-md-6">
                      <div class="form-group has-danger">
                          <label class="control-label">Jawatan Yang Diambil</label>
   ...
   <div class="col-md-6">
    ...
    <img src="../admin/upload/<?php echo $image;?>" width="150" height="150">
     <input type="hidden" name="old_img" value="<?php echo $image;?>">
        ...
        <option value="Simpan"<?php if($row['staus']=="status"){echo "selected";}?>>Simpan</option>
          <option value="Tunggu"<?php if($row['stuatus']=="status"){echo "selected";}?>>Tunggu</option>
       ...
       <input type="text"  class="form-control" id="startdate" value="<?php echo $startdate;?>" name="startdate" placeholder="Masuk Tarikh Kuatkuasa">
                                    ...
                                    <div class="form-actions">
                                      ...
                                      <button type="submit" class="btn btn-success" name="update"> <i class="fa fa-check" ></i> Kemas Kini</button>
                                        <a href="candidates2.php"><button type="button" class="btn btn-inverse">Batal</button></a>
                                    </div>
                                </form>
                            </div>
                    </div>
