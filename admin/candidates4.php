                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <a href="add_candidates4.php"><button type="button" class="btn btn-primary">Tambah Cadangan Pegawai</button></a>
...
try {
    ...
    echo "Error: " . $e->getMessage();
                       ...
                       <td style="width: 20px"><a href="candidates4.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Padam"></i></a>
