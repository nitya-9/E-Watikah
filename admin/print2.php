                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              BARISAN HADAPAN PEJABAT PENDIDIKAN DAERAH <br>
                             PEJABAT PENDIDIKAN DAERAH ______________________ </b> <img src="../admin/settings/logo1.png" style="position: absolute; right:25px; top:15px;" width="180PX" height="130PX"></h3>
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM candidate2 where flow= '".$_GET['flow']."'");
    $stmt->execute();
