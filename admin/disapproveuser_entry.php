        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Maklumat Pengguna Tidak Diaktifkan</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Pengguna Tidak Diaktifkan</a></li>
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM users where status='Deactivate'");
    $stmt->execute();
