                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              BARISAN HADAPAN ________________________________ <br>
                             PEJABAT PENDIDIKAN DAERAH ______________________ </b><img src="../admin/settings/logo1.png" style="position: absolute; right:30px; top:15px;" width="180px" height="130px"> </h3>
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM candidate4 where flow= '".$_GET['flow']."'");
    $stmt->execute();
                                ...
                                <td style='max-width: 25px; text-align: left;'>   <img src="../admin/upload/<?php echo $value['image'];?>"width="140" height="140"></td>
                                    ...
                                    <td style='max-width: 50px; text-align: left;'>
                                            ...
                                            <b>PERBEZAAN JARAK:</b>    <?php echo $value['total'];?> KM <br>
                                             <b>PERGERAKAN:</b>    <?php echo $value['modeofchange'];?> <br>
