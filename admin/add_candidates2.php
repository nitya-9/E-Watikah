...
try {
    ...
    $stmt1 = $conn->prepare("SELECT * FROM candidate2");
   $stmt1->execute();
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Cadangan Pegawai PPD</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Cadangan Pengawai PPD</a></li>
            ...
            <div class="container-fluid">
                  ...
                  <div class="card card-outline-primary">
                       <div class="card-body">
                             <form action="operations/candidate2.php" method="post"  enctype="multipart/form-data">
                                    <div class="form-body">
             ...
             <input type="hidden" name="old_img" value="<?php echo $image;?>">
                  ...
                  <option value="Tunggu">Tunggu</option>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="add_candidates2.php"><button type="button" class="btn btn-inverse">Batal</button></a>
                                    </div>
                                </form>
                            </div>
                    </div>
