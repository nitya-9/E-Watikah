...
<a href="candidates.php" class="button button--error" data-for="js_success-popup">Tidak</a>
</p>
</div>
</div>
<?php } ?>
...
try {
    ...
    $stmt = $conn->prepare("SELECT ppd FROM candidate where no='1' and flow= '".$_GET['flow']."'");
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                              <h3 class="text-primary" style="font-size: 20px; text-transform: uppercase;"> <b> PPSM PPP <?php echo $value1['noppsm'];?>/2022, CADANGAN PELANTIKAN, PERGERAKAN DAN <br> PENEMPATAN SEMULA BARISAN HADAPAN SEKOLAH RENDAH<br>
                             PEJABAT PENDIDIKAN DAERAH <?php echo $value['ppd'];?> </b> <img src="../admin/settings/logo1.png" style="position: absolute; right:90px; top:15px;" width="180PX" height="130PX"></h3>
                                    ...
                                    <table style="text-align: left; font-size:15px;" id="example233" enctype="multipart/form-data" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <td style='max-width:23px;'><b>Gambar</b></td>
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM candidate where flow= '".$_GET['flow']."'");
    $stmt->execute();
    ...
    echo "Error: " . $e->getMessage();
                            ...
                            <tr>
                                ...
                                <td style="width:10px; "><?php echo $value['no'];?></td>
                                  <td style='max-width: 25px; text-align: left; '>   <img src="../admin/upload/<?php echo $value['image'];?>"width="140" height="140">
                                    <br> <br> <br> <br> <br> <br> <center> <img src="../admin/upload/arrow.png" width="70" height="70">
                                  </td>
                                     <td style="max-width: 50px; ">
                                       <b>UNIT:</b>    <?php echo $value['unit'];?> <br>
                                    <b>NAMA:</b> <?php echo $value['name'];?> <br>
                                    <b>NO. KP:</b> <?php echo $value['icno'];?> <br>
                                    <b>JAWATAN SEMASA:</b> <?php echo $value['position'];?> <br>
                                    <b>JAWATAN SEMASA LAIN-LAIN:</b> <?php echo $value['others'];?><br>
                                    ...
                                    <b>ALAMAT RUMAH:</b> <?php echo $value['address'];?><br>
                                      ...
                                      <b>TARIKH KHIDMAT PEJABAT SEMASA:</b> <?php echo date("d-m-Y", strtotime($value['currentdate1']));?><br>
                                      <b>TARIKH LANTIKAN JAWATAN SEMASA:</b> <?php echo date("d-m-Y", strtotime($value['currentdate1']));?><br>
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
    <?php echo "<script>
  setTimeout(\"location.href='candidates.php'\", 2000);
