                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <a href="add_candidates1.php"><button type="button" class="btn btn-primary">Tambah Cadangan Pegawai</button></a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Jawatan Semasa Lain-lain</th>
...
try {
    ...
    echo "Error: " . $e->getMessage();
                            ...
                            <tr>
                                     ...
                                     <td style="width:10px"><?php echo $value['ppd'];?></td>
                       ...
                       <td style="width: 20px"><a href="candidates1.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Padam"></i></a>

                       <a href="update_candidates1.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" title="Kemas Kini"></i></a>
