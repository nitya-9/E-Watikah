...
//get invoices data
$query = mysqli_query($con,"select * from candidate1
	where
	id = '".$_GET['id']."'");
...
$pdf->Cell(23,5,'',0,0);
$pdf->SetFont('Arial','',11);
$pdf->Cell(50,5,'Unit Menengah & Tingkatan 6',0,1);
$pdf->Cell(110	,4,'',0,1);
$pdf->Cell(15	,3,'',0,0);
...
$pdf->Cell(15	,3,'',0,0);
$pdf->Cell(23,5,'',0,0);
$pdf->Cell(50,5,"Pejabat Pendidikan Daerah $ppd",0,1);
$pdf->Cell(110	,4,'',0,1);
$pdf->Cell(15	,3,'',0,0);
$pdf->Cell(23,5,'          iii.   ',0,0);
$pdf->SetFont('Arial','B',11);
$pdf->Cell(50,5,'Pengetua',0,1);
$pdf->SetFont('Arial','',11);
$pdf->Cell(15	,3,'',0,0);
$pdf->Cell(23,5,'',0,0);
...
//items
$query = mysqli_query($con,"select * from candidate1 where id = '".$candidate['id']."' ");
$tax = 0; //total tax
