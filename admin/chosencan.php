        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Pegawai Diperaku Unit Rendah</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Pegawai Diperaku Unit Rendah</a></li>
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM candidate WHERE status='Diperaku' order by flow,no");
    $stmt->execute();
 ...
 ?>
                            <tr>
                                      ...
                                      <td style="width:20px">
                                       ...
                                       <a href="update_candidates.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" title="Kemas Kini"></i></a>
                                        <a href="lettergen5.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-success"><i class="fa fa-file-pdf-o" data-toggle="tooltip" title="Guru Besar"></i></a>


                                        <a href="lettergen6.php?id=<?php

                                        echo $value['id']; ?>" class="btn btn-xs btn-success"><i class="fa fa-file-pdf-o" data-toggle="tooltip" title="Guru Besar Baharu"></i></a>
                                        <a href="lettergen.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-success"><i class="fa fa-file-pdf-o" data-toggle="tooltip" title="Jawatan Lain"></i></a>
