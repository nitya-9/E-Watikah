...
<p>
<a href="operations/candidate1.php?id=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Ya</a>
<a href="candidates1.php" class="button button--error" data-for="js_success-popup">Tidak</a>
</p>
</div>
</div>
<?php } ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                              <h3 class="text-primary" style="font-size: 20px; text-transform: uppercase;"> <b> PPSM PPP <?php echo $value1['noppsm'];?>/2022, CADANGAN PELANTIKAN, PERGERAKAN DAN <br> PENEMPATAN SEMULA
                              BARISAN HADAPAN SEKOLAH MENENGAH <br>
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM candidate1 where flow= '".$_GET['flow']."'");
    $stmt->execute();
    ...
    echo "Error: " . $e->getMessage();
                            ...
                            <tr>
                                ...
                                <br> <br> <br> <br> <br> <br> <center> <img src="../admin/upload/arrow.png" width="70" height="70"></td>
...
<!--td> Pergerakan:    <?php echo $value['modeofchange'];?> <br> </td-->
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
    <?php echo "<script>
  setTimeout(\"location.href='candidates1.php'\", 2000);
