...
try {
    ...
    if(isset($_POST['submit']))
    {
      ...
      $file_store="../../admin/upload/".$file_name;
       if (move_uploaded_file($file_tem_loc, $file_store)){
        ...
        $sql = "INSERT INTO candidate (ppd, no, flow, unit, name, icno, position, others, actgred, gred, workplace,postcode, retiredate, address, currentdate1, currentdate2, modeofchange, newplace, distancecurrent, distancenew, total,positionhist,positionhist2,positionhist3,placehist,placehist2,placehist3,startdate1,startdate2,startdate3,enddate1,enddate2,enddate3, justification, notes, takefrom, positionof,othersnewpost, image)
...

    {
       ...
       else
      {
        ...
        $sql = "UPDATE candidate SET ppd='".$_POST['ppd']."',
        no='".$_POST['no']."',
flow='".$_POST['flow']."',
  unit='".$_POST['unit']."',
        name='".$_POST['name']."',
